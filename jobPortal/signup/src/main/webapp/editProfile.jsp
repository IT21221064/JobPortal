          ...
          <div class="card-body">
            ...
            <form method="post" action="EditProfileServlet">
             <div class="row">
              ...
              <div class="col-md-6">
                <label>Address : </label
                ><input name="address"  value="ln" class="form-control" placeholder="Address" />
              </div>
            </div>
            <div class="row">
              <div class="col-md-6 form-group">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <label>DOB</label
                ><input name="dob" class="form-control" type="date" placeholder="Date" value="dob>" />
              </div>
            </div>
            ...
            <div class="col-md-4"></div>
            <div class="col-md-4">
            <input type="submit" class="btn btn-primary col-md-12" value="Edit  Account"/>
            <input type="submit" class="btn btn-primary col-md-12" value="Delete Account"/>
            </div>
            <div class="col-md-4"></div>
            </div>
            </form>
